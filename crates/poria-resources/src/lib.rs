...
pub use terminal::{
    git_add_all, git_clone, git_commit, git_current_branch, git_diff_numstat, git_fetch,
    git_has_changes, git_list_branches, git_push_set_upstream, git_show_path, git_status_porcelain,
    git_sync_hosted_clone, TerminalExecInput, TerminalExecResult, TerminalResource,
};
...
pub use claude::output_guard::{
    collect_worktree_agent_output, default_blocked_dependencies, parse_numstat_total,
    parse_porcelain_paths, AgentOutput, DependencyEntry, GuardResult, OutputGuard,
    OutputGuardConfig, Violation, ViolationSeverity, ViolationType,
};
pub use claude::path::{
