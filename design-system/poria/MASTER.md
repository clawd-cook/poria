...
| Secondary        | `#EBE8E3` | `--color-secondary`        |
| On Secondary     | `#1C1917` | `--color-on-secondary`     |
| Accent/CTA       | `#A16207` | `--color-accent`           |
| On Accent/CTA    | `#FFFFFF` | `--color-on-accent`        |
| Background       | `#FAFAF8` | `--color-background`       |
...
| Border           | `#E7E3DC` | `--color-border`           |
| Sidebar          | `#EBE8E3` | `--color-sidebar`          |
| Destructive      | `#DC2626` | `--color-destructive`      |
| On Destructive   | `#FFFFFF` | `--color-on-destructive`   |
| Ring             | `#DC2626` | `--color-ring`             |

**Color Notes:** Light canvas `#FAFAF8`; sidebar `#EBE8E3` (not white). Terracotta is for CTAs only. Accent gold `#A16207`.
